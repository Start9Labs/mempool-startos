...
describe("builder tests", () => {
    test("text", async () => {
        const bitcoinPropertiesBuilt = await Config.of({
...
describe("values", () => {
    ...
    test("list", async () => {
        const value = Value.list(List.number({
            name: "test",
        }, {
            integer: false,
        }));
    ...
    describe("dynamic", () => {
        ...
        test("datetime", async () => {
            const value = Value.dynamicDatetime(async ({ utils }) => {
                ;
                async () => {
                    ;
                    (await utils.getOwnWrapperData("/test").once());
                };
                return {
                    name: "Testing",
                    required: { default: null },
...
describe("Builder List", () => {
    test("obj", async () => {
        const value = Value.list(List.obj({
            name: "test",
        }, {
            spec: Config.of({
                test: Value.toggle({
    ...
    test("text", async () => {
        const value = Value.list(List.text({
            name: "test",
        }, {
            patterns: [],
        }));
    ...
    describe("dynamic", () => {
        test("text", async () => {
            const value = Value.list(List.dynamicText(() => ({
                name: "test",
                spec: { patterns: [] },
            })));
            const validator = value.validator;
    ...
    test("number", async () => {
        const value = Value.list(List.dynamicNumber(() => ({
            name: "test",
            spec: { integer: true },
        })));
        const validator = value.validator;
