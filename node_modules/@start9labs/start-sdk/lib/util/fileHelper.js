...
export class FileHelper {
    ...
    writeData;
    readData;
    constructor(path, volume, writeData, readData) {
        this.path = path;
        this.volume = volume;
        this.writeData = writeData;
        this.readData = readData;
    }
    async write(data, effects) {
        let matched;
    ...
    async read(effects) {
        ...
        return this.readData(await effects.readFile({
            path: this.path,
            volumeId: this.volume,
        }));
    }
     ...
     */
    static raw(path, volume, toFile, fromFile) {
        return new FileHelper(path, volume, toFile, fromFile);
    }
    /**
     * Create a File Helper for a .json file
     */
    static json(path, volume, shape) {
        return new FileHelper(path, volume, (inData) => {
